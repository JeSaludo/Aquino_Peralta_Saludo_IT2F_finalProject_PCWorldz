...
>>>>>>> 339859f39da7db9be23299efbe24037cf8e0e072
  ...
  <div class="section-navigation-wrap">
    ...
    <div class="section-navigation">
      ...
      <p class="section-navigation-path">
        ...
        <span class="path current">Login Popup</span>
      </p>
      <!-- SECTION NAVIGATION PATH -->
    </div>
    <!-- /SECTION NAVIGATION -->
  ...
  <div class="section-wrap dark">
    ...
    <div class="section form-demo">
      ...
      <div class="form-popup medium">
        ...
        <div class="form-popup-column small">
          ...
          <form>
            <!-- FORM ROW -->
            <div class="form-row">
              <label for="email_s" class="rl-label">Email</label>
              <input type="text" id="email_s" name="email_s" placeholder="Enter your email...">
            </div>
            <!-- /FORM ROW -->

            <!-- FORM ROW -->
            <div class="form-row">
              <label for="password_s" class="rl-label">Password</label>
              <input type="password" id="password_s" name="password_s" placeholder="Enter your password...">
            </div>
            <!-- /FORM ROW -->
        ...
        <div class="form-popup-column small">
          ...
          <form>
            <!-- FORM ROW -->
            <div class="form-row">
              <label for="username_s" class="rl-label">Username</label>
              <input type="text" id="username_s" name="username_s" placeholder="Enter your username...">
            </div>
            <!-- /FORM ROW -->

            <!-- FORM ROW -->
            <div class="form-row">
              <label for="password2_s" class="rl-label">Password</label>
              <input type="password" id="password2_s" name="password2_s" placeholder="Enter your password...">
            </div>
            <!-- /FORM ROW -->
            ...
            <div class="form-row">
              <!-- CHECKBOX -->
    					<input type="checkbox" id="keep_logged_s" name="keep_logged_s" checked>
    					<label class="checkbox" for="keep_logged_s">
    						<span class="box">
                  <!-- SVG CHECK -->
    						  <svg class="svg-check">
    						    <use xlink:href="#svg-check"></use>
      ...
      <a href="index.html" class="button centered popup-trigger">Popup Demo</a>
    </div>
    <!-- /SECTION -->
  </div>
  <!-- /SECTION WRAP -->
