...
<head>
  ...
  <title>PcWorldz | Graphics Cards</title>
</head>
<body>
...
<?php
  ...
  <div class="section-navigation-wrap">
    ...
    <div class="section-navigation">
      ...
      <p class="section-navigation-path">
        ...
        <span class="path current">Browse All</span>
      </p>
      <!-- SECTION NAVIGATION PATH -->
    </div>
    <!-- /SECTION NAVIGATION -->
  ...
  <div class="section-wrap">
    ...
    <div class="section no-title">
      ...
      <h3 class="title large">browse all designs items</h3>
      <hr class="line-separator">
      <!-- FILTER HEADER -->
      <div class="filter-header">
        <h6 class="title">Showing 1 out of 128 results</h6>
        <!-- VIEW SELECTORS -->
        <div class="view-selectors">
          <!-- VIEW SELECTOR -->
          <a href="#" class="view-selector">
            <!-- SVG GRID -->
            <svg class="svg-grid">
          ...
          <!-- VIEW SELECTOR -->
          <a href="#" class="view-selector selected">
            <!-- SVG LIST -->
            <svg class="svg-list">
          ...
          <div class="filter-option">
            ...
            <label for="items_page2" class="select-block">
							<select name="items_page2" id="items_page2">
								<option value="0">6 Items per Page</option>
      ...
      <div class="product-list v2">
        ...
        <div class="product-list-item">
          ...
          <a href="#">
            <figure class="product-img">
              <img src="img/products/013.png" alt="product01">
            </figure>
          </a>
          <!-- /PRODUCT IMG -->
        ...
        <div class="product-list-item">
          ...
          <a href="#">
            <figure class="product-img">
              <img src="img/products/014.png" alt="product02">
            </figure>
          </a>
          <!-- /PRODUCT IMG -->
        ...
        <div class="product-list-item">
          ...
          <a href="#">
            <figure class="product-img">
              <img src="img/products/015.png" alt="product03">
            </figure>
          </a>
          <!-- /PRODUCT IMG -->
        ...
        <div class="product-list-item">
          ...
          <a href="#">
            <figure class="product-img">
              <img src="img/products/016.png" alt="product05">
            </figure>
          </a>
          <!-- /PRODUCT IMG -->
        ...
        <div class="product-list-item">
          ...
          <a href="#">
            <figure class="product-img">
              <img src="img/products/017.png" alt="product06">
            </figure>
          </a>
          <!-- /PRODUCT IMG -->
        ...
        <div class="product-list-item">
          ...
          <a href="#">
            <figure class="product-img">
              <img src="img/products/018.png" alt="product04">
            </figure>
          </a>
          <!-- /PRODUCT IMG -->
