  ...
  <div class="section-wrap">
    ...
    <div class="section top-short">
      ...
      <div class="column-3-2-wrap">
        ...
        <div class="column">
          ...
          <div class="section-message">
            ...
            <div class="section-decoration">
              <!-- SVG CART -->
              <svg class="svg-cart large">
                <use xlink:href="#svg-cart"></use>
              </svg>
              <!-- /SVG CART -->

              <!-- SVG CHECK BIG -->
              <svg class="svg-check-big">
                <use xlink:href="#svg-check-big"></use>
              </svg>
              <!-- /SVG CHECK BIG -->
            </div>
            <!-- /SECTION DECORATION -->
            <h3 class="title medium">Order Successfully Received</h3>
            <h5 class="title small">Thanks for your purchase!</h5>
          </div>
          <!-- /SECTION MESSAGE -->
        </div>
        <!-- /COLUMN -->
        ...
        <!-- COLUMN -->
        <div class="column">
          <h2 class="subsection-title">Order Details (ID: <span class="bold">256ASD5E85</span>)</h2>
          <hr class="line-separator">
          <!-- DETAILS LIST -->
          <div class="details-list">
            <!-- DETAILS LIST ITEM -->
            <div class="details-list-item">
              <h6 class="details-list-title">Billing Details</h6>
              <p class="details-list-info"><span>Name:</span> Jessica Valentine</p>
              <p class="details-list-info"><span>Email:</span> jvalentine@yourmail.com</p>
              <p class="details-list-info"><span>Phone:</span> 044-555-1234-1234</p>
              <p class="details-list-info"><span>Address:</span> Branchwood Ave 265 Los Angeles, USA</p>
            </div>
            <!-- /DETAILS LIST ITEM -->

            <!-- DETAILS LIST ITEM -->
            <div class="details-list-item">
              <h6 class="details-list-title">Shipping Details</h6>
              <p class="details-list-info"><span>Name:</span> Jessica Valentine</p>
              <p class="details-list-info"><span>Email:</span> jvalentine@yourmail.com</p>
              <p class="details-list-info"><span>Phone:</span> 044-555-1234-1234</p>
              <p class="details-list-info"><span>Address:</span> Branchwood Ave 265 Los Angeles, USA</p>
            ...
            <!-- DETAILS LIST ITEM -->
            <div class="details-list-item">
              <h6 class="details-list-title">Cart Details</h6>
              <p class="details-list-info"><span class="push">GIGABYTE X570 AORUS XTREME x 4</span> ₱233,848</p>
              <p class="details-list-info"><span class="push">ASUS ROG CROSSHAIR III DARK HERO x 2</span>₱57,032</p>
              <p class="details-list-info"><span class="push">ASUS ROG STRIX B550-F GAMING x 1</span>₱12,947</p>
              <p class="details-list-info"><span class="push">Shipping &amp; Handling</span> ₱100</p>
              <p class="details-list-info"><span class="push">Coupon Discount</span> -₱100</p>
              <p class="details-list-info"><span class="push">TOTAL</span> <span>₱303,827</span></p>
            </div>
            <!-- /DETAILS LIST ITEM -->

            <!-- DETAILS LIST ITEM -->
            <div class="details-list-item">
              <h6 class="details-list-title">Payment Method</h6>
              <p class="details-list-info"><span>CREDIT CARD</span></p>
              <p class="details-list-info"><span>Name:</span> Jessica Valentine</p>
              <p class="details-list-info"><span>Email:</span> jvalentine@yourmail.com</p>
              <p class="details-list-info"><span>Card Number:</span> ****-****-5263</p>
              <p class="details-list-info"><span>Address:</span> Branchwood Ave 265 Los Angeles, USA</p>
            </div>
            <!-- /DETAILS LIST ITEM -->
          </div>
      ...
      <div class="section-actions">
        <a href="index.html" class="button dark">Return to Home</a>
        <a href="shop-sidebar-grid.html" class="button">Continue Shopping</a>
      </div>
      <!-- /SECTION ACTIONS -->
    </div>
    <!-- /SECTION -->
...
<!-- SVG ICONS -->
  ...
  <svg style="display: none;">
   <symbol id="svg-check-big" viewBox="0 0 130 102" preserveAspectRatio="xMinYMin meet">
      <path fill-rule="evenodd" clip-rule="evenodd" d="M129.05,18.41l-81.938,82.641c-1.274,1.285-3.341,1.285-4.616,0
