...
echo '<!-- /SVG ARROW -->';
echo '</span>';
echo '<span class="path current">About Us</span>';
echo '</p>';
echo '<!-- SECTION NAVIGATION PATH -->';
echo '</div>';
echo '<!-- /SECTION NAVIGATION -->';
...
echo '<!-- /SECTION NAVIGATION WRAP -->';
echo '';
echo '<!-- ABOUTUS BANNER WRAP -->';
echo '<div class="aboutus-banner-wrap">';
echo '<div class="aboutus-banner-bg-fill"></div>';
echo '<!-- ABOUTUS BANNER -->';
echo '<div class="aboutus-banner">';
echo '<!-- ABOUTUS BANNER CONTENT -->';
echo '<div class="aboutus-banner-content">';
echo '<h6 class="title secondary">Welcome to<br><span class="bold">PC WORLDZ</span></h6>';
echo '<p class="title">Your number one source of Computer Products</p>';
echo '<p>We are dedicated to give you the very best of Computer Products, with a focus on quality, price and uniqueness. Founded in 2022 by Saludo, Peralta and Aquino, PC WORLDZ serves customer worldwide, and are thrilled to be a part of the fair trade wing of the IT industry.</p>';
echo '<p>We hope you enjoy our products as much as we enjoy offering them to you. If you have any questions or comments, please do not hesitate to contact us.</p>';
echo '<a href="#" class="button medium">Search Products</a>';
echo '</div>';
echo '<!-- /ABOUTUS BANNER CONTENT -->';
echo '</div>';
echo '<!-- /ABOUTUS BANNER -->';
...
echo '<div class="features-section section">';
echo '<h6 class="pretitle">Look at all the</h6>';
echo '<h3 class="title large">Computer Features</h3>';
echo '<hr class="line-separator short">';
echo '';
echo '<!-- FEATURE LIST -->';
echo '<ul class="feature-list big">';
echo '<!-- FEATURE LIST ITEM -->';
echo '<li class="feature-list-item">';
echo '<i class="s-icon icon-energy"></i>';
echo '<p class="title">Ultra Durability</p>';
echo '<p>We built a fully durable products to let our customer enjoy it.</p>';
echo '</li>';
echo '<!-- /FEATURE LIST ITEM -->';
echo '';
echo '<!-- FEATURE LIST ITEM -->';
echo '<li class="feature-list-item">';
echo '<i class="s-icon icon-drop"></i>';
echo '<p class="title">Water Resistant</p>';
echo '<p>Some of our products can resist in waters but not in huge amount of time.</p>';
echo '</li>';
echo '<!-- /FEATURE LIST ITEM -->';
echo '';
echo '<!-- FEATURE LIST ITEM -->';
echo '<li class="feature-list-item">';
echo '<i class="s-icon icon-star"></i>';
echo '<p class="title">Super Comfort</p>';
echo '<p>We make our products easy set up to make our customers building it comfortable.</p>';
echo '</li>';
echo '<!-- /FEATURE LIST ITEM -->';
echo '';
echo '<!-- FEATURE LIST ITEM -->';
...
echo '<p class="title">Special Designs</p>';
echo '<p>We added some designs to make our product more attractable like neon lights and some tubes for water flows to make it.</p>';
echo '</li>';
echo '<!-- /FEATURE LIST ITEM -->';
echo '';
echo '<!-- FEATURE LIST ITEM -->';
echo '<li class="feature-list-item">';
echo '<i class="s-icon icon-like"></i>';
echo '<p class="title">Quality Warranty</p>';
echo '<p>It depends on the item you buy. But most of products in our store we give our customer 1 year warranty.</p>';
echo '</li>';
echo '<!-- /FEATURE LIST ITEM -->';
echo '';
echo '<!-- FEATURE LIST ITEM -->';
echo '<li class="feature-list-item">';
echo '<i class="s-icon icon-wrench"></i>';
echo '<p class="title">Product Builder</p>';
echo '<p>You can customize your own ideal version of PC products to give us more infos and add some features.</p>';
echo '</li>';
echo '<!-- /FEATURE LIST ITEM -->';
echo '</ul>';
echo '<!-- /FEATURE LIST -->';
