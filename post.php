...
>>>>>>> 339859f39da7db9be23299efbe24037cf8e0e072
  ...
  <div class="post-header">
    <figure class="post-img large">
      <img src="img/blog/post/09.jpg" alt="post09">
    </figure>
  </div>
  <!-- /POST HEADER -->
  ...
  <div class="section-wrap">
    ...
    <div class="section void">
      ...
      <div class="open-post">
        ...
        <!-- TEXT ROW -->
        <div class="text-row">
          <iframe src="https://player.vimeo.com/video/109558222"></iframe>
        </div>
        <!-- /TEXT ROW -->
        ...
        <!-- COMMENTS -->
        <div class="comments">
          <h2 class="subsection-title big">Comments (182)</h2>
          <hr class="line-separator">
        ...
        <div class="response-form">
          <h2 class="subsection-title big">Write a Comment</h2>
          <hr class="line-separator">
          ...
          <form>
            ...
            <!-- FORM ROW -->
            <div class="form-row">
              <label for="c_comment" class="rl-label">Comment</label>
              <textarea id="c_comment" name="c_comment" placeholder="Write your comment here..."></textarea>
            </div>
            <!-- /FORM ROW -->

            <!-- FORM ROW -->
            <div class="form-row separated">
              <button class="button medium">Post your Comment</button>
            </div>
            <!-- /FORM ROW -->
          </form>
          <!-- /FORM -->
