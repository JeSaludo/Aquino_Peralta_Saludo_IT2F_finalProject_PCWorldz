...
echo '<!-- SECTION -->';
echo '<div class="section top-short bottom-shorter">';
echo '<!-- STEPS HEADER -->';
...
echo '';
echo '<!-- STEPS HEADER ITEM -->';
echo '<div class="steps-header-item">';
echo '<!-- STEP NUMBER -->';
echo '<div class="step-number">';
echo '<p>02.</p>';
echo '</div>';
...
echo '<h2 class="subsection-title">Create a new Account</h2>';
echo '<hr class="line-separator">';
echo '<p class="small">Fill all the requirements on the space provided.</p>';
echo '<!-- FORM -->';
echo '<form>';
echo '<!-- FORM ROW -->';
echo '<div class="form-row">';
echo '<label for="email3" class="rl-label">Email</label>';
echo '<input type="text" id="email3" name="email3" placeholder="Enter your email...">';
echo '</div>';
echo '<!-- /FORM ROW -->';
echo '';
echo '<!-- FORM ROW -->';
echo '<div class="form-row">';
echo '<label for="password3" class="rl-label">Password</label>';
echo '<input type="password" id="password3" name="password3" placeholder="Enter your password...">';
echo '</div>';
echo '<!-- /FORM ROW -->';
echo '';
echo '<!-- FORM ROW -->';
echo '<div class="form-row separated">';
echo '<button class="button dark long">Register Now</button>';
echo '</div>';
echo '<!-- /FORM ROW -->';
echo '';
echo '<!-- FORM ROW -->';
echo '<div class="form-row">';
echo '<button class="button light long">Checkout as Guest</button>';
echo '</div>';
echo '<!-- /FORM ROW -->';
echo '</form>';
echo '<!-- /FORM -->';
...
echo '<!-- COLUMN -->';
echo '<div class="column">';
echo '<h2 class="subsection-title">Login to your Account</h2>';
echo '<hr class="line-separator">';
echo '<!-- FORM -->';
echo '<form>';
echo '<!-- FORM ROW -->';
echo '<div class="form-row">';
echo '<label for="email4" class="rl-label">Email</label>';
echo '<input type="text" id="email4" name="email4" placeholder="Enter your email...">';
echo '</div>';
echo '<!-- /FORM ROW -->';
echo '';
echo '<!-- FORM ROW -->';
echo '<div class="form-row">';
echo '<label for="password4" class="rl-label">Password</label>';
echo '<input type="password" id="password4" name="password4" placeholder="Enter your password...">';
echo '</div>';
echo '<!-- /FORM ROW -->';
echo '';
echo '<!-- FORM ROW -->';
echo '<div class="form-row">';
echo '<!-- CHECKBOX -->';
echo '<input type="checkbox" id="keep_logged2" name="keep_logged2" checked>';
echo '<label class="checkbox" for="keep_logged2">';
echo '<span class="box">';
echo '<!-- SVG CHECK -->';
echo '<svg class="svg-check">';
echo '<use xlink:href="#svg-check"></use>';
...
echo '<!-- FORM ROW -->';
echo '<div class="form-row short-space separated">';
echo '<button class="button long">Login to your Account</button>';
echo '</div>';
echo '<!-- /FORM ROW -->';
echo '';
echo '<!-- FORM ROW -->';
echo '<div class="form-row">';
echo '<div class="half">';
echo '<a href="#" class="button blue full">Login via Facebook</a>';
echo '</div>';
echo '<div class="half">';
echo '<a href="#" class="button lightblue full">Login via Twitter</a>';
echo '</div>';
echo '</div>';
echo '<!-- /FORM ROW -->';
echo '</form>';
