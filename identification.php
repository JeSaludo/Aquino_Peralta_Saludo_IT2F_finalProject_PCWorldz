...
<head>
  ...
  <title>The Trickster | Identification</title>
</head>
<body>
  ...
  <div class="section-wrap">
    ...
    <div class="section top-short bottom-shorter">
      ...
      <div class="column-full-2-wrap">
        <!-- COLUMN -->
        <div class="column">
          <h2 class="subsection-title">Create a new Account</h2>
          <hr class="line-separator">
          <p class="small">Lorem ipsum dolor sit amet, consectetur ipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
          <!-- FORM -->
          <form>
            <!-- FORM ROW -->
            <div class="form-row">
              <label for="email3" class="rl-label">Email</label>
              <input type="text" id="email3" name="email3" placeholder="Enter your email...">
            </div>
            <!-- /FORM ROW -->

            <!-- FORM ROW -->
            <div class="form-row">
              <label for="password3" class="rl-label">Password</label>
              <input type="password" id="password3" name="password3" placeholder="Enter your password...">
            </div>
            <!-- /FORM ROW -->

            <!-- FORM ROW -->
            <div class="form-row separated">
              <button class="button dark long">Register Now</button>
            </div>
            <!-- /FORM ROW -->

            <!-- FORM ROW -->
            <div class="form-row">
              <button class="button light long">Checkout as Guest</button>
            </div>
            <!-- /FORM ROW -->
          </form>
          <!-- /FORM -->
        ...
        <!-- COLUMN -->
        <div class="column">
          <h2 class="subsection-title">Login to your Account</h2>
          <hr class="line-separator">
          <!-- FORM -->
          <form>
            <!-- FORM ROW -->
            <div class="form-row">
              <label for="email4" class="rl-label">Email</label>
              <input type="text" id="email4" name="email4" placeholder="Enter your email...">
            </div>
            <!-- /FORM ROW -->

            <!-- FORM ROW -->
            <div class="form-row">
              <label for="password4" class="rl-label">Password</label>
              <input type="password" id="password4" name="password4" placeholder="Enter your password...">
            </div>
            <!-- /FORM ROW -->
            ...
            <div class="form-row">
              <!-- CHECKBOX -->
    					<input type="checkbox" id="keep_logged2" name="keep_logged2" checked>
    					<label class="checkbox" for="keep_logged2">
    						<span class="box">
                  <!-- SVG CHECK -->
    						  <svg class="svg-check">
    						    <use xlink:href="#svg-check"></use>
            ...
            <!-- FORM ROW -->
            <div class="form-row short-space separated">
              <button class="button long">Login to your Account</button>
            </div>
            <!-- /FORM ROW -->
            ...
            <div class="form-row">
              <div class="half">
                <a href="#" class="button blue full">Login via Facebook</a>
              </div>
              <div class="half">
                <a href="#" class="button lightblue full">Login via Twitter</a>
              </div>
            </div>
            <!-- /FORM ROW -->
          </form>
