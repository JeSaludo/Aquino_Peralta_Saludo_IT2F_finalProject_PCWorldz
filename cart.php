...
<body>
  ...
  <div class="section-wrap">
    ...
    <div class="section no-title bottom-void">
      <h2 class="subsection-title">Shopping Cart</h2>
      <hr class="line-separator">
  ...
  <div class="section-wrap">
    <!-- SECTION -->
    <div class="section no-title bottom-shorter">
      <!-- COLUMN BIG 3 WRAP -->
      <div class="column-big-3-wrap">
        <!-- COLUMN -->
        <div class="column">
          <h2 class="subsection-title">Calculate Shipping</h2>
          <hr class="line-separator">
          <!-- FORM -->
          <form>
            <!-- FORM ROW -->
            <div class="form-row">
              <label class="rl-label">Select your Country</label>
              <!-- SELECT BLOCK -->
              <label for="country" class="select-block medium">
  							<select name="country" id="country">
                  <option value="0">Select Country</option>
  								<option value="1">United States (USA)</option>
                  <option value="2">Spain (SPA)</option>
  								<option value="3">Germany (GER)</option>
  							</select>
  							<!-- SVG ARROW -->
  							<svg class="svg-arrow face-down">
  								<use xlink:href="#svg-arrow"></use>
            ...
            <div class="form-row">
              <div class="third">
                <label class="rl-label">Select your State</label>
                <!-- SELECT BLOCK -->
                <label for="state" class="select-block medium">
    							<select name="state" id="state">
    								<option value="0">State / City</option>
              ...
              <div class="third">
                <label for="zip_code" class="rl-label">Zip Code</label>
            ...
            <!-- FORM ROW -->
            <div class="form-row separated">
              <button class="button short dark">Update Shipping</button>
            </div>
            <!-- /FORM ROW -->
          </form>
          <!-- /FORM -->
        ...
        <!-- COLUMN -->
        <div class="column">
          <h2 class="subsection-title">Coupon Code</h2>
          <hr class="line-separator">
          <p class="small">If you have a promotional or a discount code, please enter it right here to redeem it!</p>
          <!-- FORM -->
          <form>
            <!-- FORM ROW -->
            <div class="form-row">
              <label for="coupon_code" class="rl-label">Coupon Code</label>
              <input type="text" class="short" id="coupon_code" name="coupon_code" placeholder="Enter coupon code...">
            </div>
            <!-- /FORM ROW -->

            <!-- FORM ROW -->
            <div class="form-row separated">
              <button class="button short dark">Redeem Code</button>
            </div>
            <!-- /FORM ROW -->
          </form>
          <!-- /FORM -->
        ...
        <!-- COLUMN -->
        <div class="column">
          <h2 class="subsection-title">Cart Totals</h2>
          <hr class="line-separator">
          <!-- ONELINE -->
          <p class="oneline">Cart Subtotal<span class="annotation">₱303,827</span></p>
          <!-- /ONELINE -->
          ...
          <!-- ONELINE -->
          <p class="oneline">Cart Totals<span class="annotation bold">₱303,927</span></p>
          <!-- /ONELINE -->
