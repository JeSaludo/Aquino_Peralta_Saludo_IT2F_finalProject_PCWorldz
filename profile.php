...
echo '<!-- /SVG ARROW -->';
echo '</span>';
echo '<span class="path current">My Account</span>';
echo '</p>';
echo '<!-- SECTION NAVIGATION PATH -->';
echo '</div>';
echo '<!-- /SECTION NAVIGATION -->';
...
echo '<h2 class="subsection-title">Welcome Back!</h2>';
echo '<hr class="line-separator">';
echo '<!-- WIDGET DROPDOWN -->';
echo '<ul class="widget-dropdown">';
echo '<!-- WIDGET DROPDOWN ITEM -->';
echo '<li class="widget-dropdown-item">';
echo '<a href="profile.php">Personal Information</a>';
echo '</li>';
echo '<!-- /WIDGET DROPDOWN ITEM -->';
echo '';
echo '<!-- WIDGET DROPDOWN ITEM -->';
echo '<li class="widget-dropdown-item">';
echo '<a href="#">Billing Information</a>';
echo '</li>';
echo '<!-- /WIDGET DROPDOWN ITEM -->';
echo '';
echo '<!-- WIDGET DROPDOWN ITEM -->';
echo '<li class="widget-dropdown-item">';
echo '<a href="#">Shipping Information</a>';
echo '</li>';
echo '<!-- /WIDGET DROPDOWN ITEM -->';
echo '</ul>';
echo '<!-- /WIDGET DROPDOWN -->';
...
echo '<h2 class="subsection-title">Personal Information</h2>';
echo '<hr class="line-separator">';
echo '<!-- FORM -->';
echo '<form>';
echo '<!-- FORM ROW -->';
...
echo '<input type="text" id="fname" name="fname" placeholder="Enter your first name...">';
echo '</div>';
echo '';
echo '<div class="half">';
echo '<label for="lname" class="rl-label required">Last Name</label>';
echo '<input type="text" id="lname" name="lname" placeholder="Enter your last name...">';
echo '</div>';
echo '</div>';
echo '<!-- /FORM ROW -->';
echo '';
...
echo '<input type="text" id="bd_email" name="bd_email" placeholder="Enter your email...">';
echo '</div>';
echo '';
echo '<div class="half">';
echo '<label for="cname" class="rl-label">Phone Number</label>';
echo '<input type="text" id="cname" name="cname" placeholder="Enter your phone number...">';
echo '</div>';
echo '</div>';
echo '<!-- /FORM ROW -->';
echo '';
...
echo '<input type="text" id="staddress" name="staddress" placeholder="Enter your street address...">';
echo '</div>';
echo '<div class="half no-label">';
echo '<input type="text" id="apart" name="apart" placeholder="Enter the apartment, floor, suite, etc...">';
echo '</div>';
echo '</div>';
echo '<!-- /FORM ROW -->';
echo '';
...
echo '<input type="text" id="bd_zipcode" name="bd_zipcode" placeholder="Enter your ZIP code...">';
echo '</div>';
echo '</div>';
echo '</div>';
echo '<!-- /FORM ROW -->';
...
echo '<div class="half">';
echo '<div class="half">';
echo '<label class="rl-label">Birth Date</label>';
echo '<!-- SELECT BLOCK -->';
echo '<label for="bd_month" class="select-block medium">';
echo '<select name="bd_month" id="bd_month">';
...
echo '<div class="half no-label">';
echo '<!-- SELECT BLOCK -->';
echo '<label for="bd_day" class="select-block medium">';
echo '<select name="bd_day" id="bd_day">';
echo '<option value="0">01</option>';
echo '<option value="1">02</option>';
echo '</select>';
echo '<!-- SVG ARROW -->';
echo '<svg class="svg-arrow face-down">';
echo '<use xlink:href="#svg-arrow"></use>';
...
echo '<div class="half no-label">';
echo '<!-- SELECT BLOCK -->';
echo '<label for="bd_year" class="select-block medium">';
echo '<select name="bd_year" id="bd_year">';
echo '<option value="0">1983</option>';
echo '<option value="1">1984</option>';
echo '</select>';
echo '<!-- SVG ARROW -->';
echo '<svg class="svg-arrow face-down">';
echo '<use xlink:href="#svg-arrow"></use>';
...
echo '';
echo '<div class="half">';
echo '<label for="sec_phone" class="rl-label">Secondary Phone</label>';
echo '<input type="text" id="sec_phone" name="sec_phone" placeholder="Enter your phone number...">';
echo '</div>';
echo '</div>';
echo '<!-- /FORM ROW -->';
echo '';
echo '<!-- FORM ROW -->';
echo '<div class="form-row right">';
echo '<button class="button">Save all Changes</button>';
echo '</div>';
echo '<!-- /FORM ROW -->';
echo '</form>';
echo '<!-- /FORM -->';
    ...
    <div class="section no-title">
      ...
      <div class="content right">
        ...
        <form>
          ...
          <div class="form-row">
            <div class="half">
              <label for="fname" class="rl-label required">First Name</label>
              <input type="text" id="fname" name="fname" placeholder="Enter your first name...">
            </div>

            <div class="half">
              <label for="lname" class="rl-label required">Last Name</label>
          ...
          <div class="form-row">
            <div class="half">
              <label for="bd_email" class="rl-label required">Email</label>
              <input type="text" id="bd_email" name="bd_email" placeholder="Enter your email...">
            </div>

            <div class="half">
              <label for="cname" class="rl-label">Phone Number</label>
              <input type="text" id="cname" name="cname" placeholder="Enter your phone number...">
            </div>
          </div>
          <!-- /FORM ROW -->
          ...
          <div class="form-row">
            <div class="half">
              <label for="staddress" class="rl-label required">Address</label>
              <input type="text" id="staddress" name="staddress" placeholder="Enter your street address...">
            </div>
            <div class="half no-label">
              <input type="text" id="apart" name="apart" placeholder="Enter the apartment, floor, suite, etc...">
            </div>
          </div>
          <!-- /FORM ROW -->
          ...
          <div class="form-row">
            <div class="half">
              ...
              <!-- SELECT BLOCK -->
              <label for="bd_country" class="select-block medium">
                <select name="bd_country" id="bd_country">
                  <option value="0">Select your country...</option>
                  <option value="1">United States (USA)</option>
                  <option value="2">Germany (GER)</option>
                </select>
                <!-- SVG ARROW -->
                <svg class="svg-arrow face-down">
                  <use xlink:href="#svg-arrow"></use>
            ...
            <div class="half">
              <div class="half">
                <label class="rl-label required">State</label>
                <!-- SELECT BLOCK -->
                <label for="bd_state" class="select-block medium">
                  <select name="bd_state" id="bd_state">
              ...
              <div class="half">
                <label for="bd_zipcode" class="rl-label required">Zip Code</label>
                <input type="text" id="bd_zipcode" name="bd_zipcode" placeholder="Enter your ZIP code...">
              </div>
            </div>
          </div>
          <!-- /FORM ROW -->
          ...
          <div class="form-row">
            <div class="half">
              <div class="half">
                ...
                <!-- SELECT BLOCK -->
                <label for="bd_month" class="select-block medium">
              ...
              <div class="half">
                <div class="half no-label">
                <!-- SELECT BLOCK -->
                <label for="bd_day" class="select-block medium">
                ...
                <div class="half no-label">
                  <!-- SELECT BLOCK -->
                  <label for="bd_year" class="select-block medium">
            ...
            <div class="half">
              <label for="sec_phone" class="rl-label">Secondary Phone</label>
              <input type="text" id="sec_phone" name="sec_phone" placeholder="Enter your phone number...">
            </div>
          </div>
          <!-- /FORM ROW -->
          ...
          <div class="form-row right">
            <button class="button">Save all Changes</button>
          </div>
          <!-- /FORM ROW -->
        </form>
        <!-- /FORM -->
...
>>>>>>> 0b4dca17d9493e7e5dde08f257e92c83bb7e008a
  <!-- /SVG BURGER -->
<!-- /SVG ICONS -->
