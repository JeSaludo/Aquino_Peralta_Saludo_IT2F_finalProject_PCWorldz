...
<head>
  ...
  <title>PcWorldz | Processor</title>
</head>
<body>
...
echo '<figcaption>The Trickster</figcaption>';
echo '</figure>';
echo '<!-- /LOGO -->';
echo '';
...
?>
      ...
      echo '<!-- /SVG ARROW -->';
      echo '</span>';
      echo '<span class="path current">Browse All</span>';
      echo '</p>';
      echo '<!-- SECTION NAVIGATION PATH -->';
      echo '</div>';
      echo '<!-- /SECTION NAVIGATION -->';
      ...
      echo '<h6 class="pretitle">welcome to pc worldz</h6>';
      echo '<h3 class="title large">browse all items</h3>';
      echo '<hr class="line-separator">';
      echo '<!-- FILTER HEADER -->';
      echo '<div class="filter-header">';
      echo '<h6 class="title">Showing 1 out of 128 results</h6>';
      echo '<!-- VIEW SELECTORS -->';
      echo '<div class="view-selectors">';
      echo '<!-- VIEW SELECTOR -->';
      echo '<a href="#" class="view-selector">';
      echo '<!-- SVG GRID -->';
      echo '<svg class="svg-grid">';
      echo '<use xlink:href="#svg-grid"></use>';
      echo '</svg>';
      echo '<!-- /SVG GRID -->';
      echo '</a>';
      echo '<!-- /VIEW SELECTOR -->';
      echo '';
      echo '<!-- VIEW SELECTOR -->';
      echo '<a href="#" class="view-selector selected">';
      echo '<!-- SVG LIST -->';
      echo '<svg class="svg-list">';
      echo '<use xlink:href="#svg-list"></use>';
      echo '</svg>';
      echo '<!-- /SVG LIST -->';
      echo '</a>';
      echo '<!-- /VIEW SELECTOR -->';
      ...
      echo '<h6 class="title">Sort by:</h6>';
      echo '<!-- SELECT BLOCK -->';
      echo '<label for="price_filter" class="select-block">';
      echo '<select name="price_filter" id="price_filter">';
      echo '<option value="0">Product Rating</option>';
      echo '<option value="1">Product Price</option>';
      echo '</select>';
      echo '<!-- SVG ARROW -->';
      echo '<svg class="svg-arrow face-down">';
      echo '<use xlink:href="#svg-arrow"></use>';
      ...
      echo '<!-- FILTER OPTION -->';
      echo '<div class="filter-option">';
      echo '<h6 class="title">Arrange:</h6>';
      echo '<!-- SELECT BLOCK -->';
      echo '<label for="items_page" class="select-block">';
      echo '<select name="items_page" id="items_page">';
      echo '<option value="0">Latest</option>';
      echo '<option value="1">Lowest to Highest</option>';
      echo '<option value="2">Highest to Lowest</option>';
      echo '</select>';
      echo '<!-- SVG ARROW -->';
      echo '<svg class="svg-arrow face-down">';
      echo '<use xlink:href="#svg-arrow"></use>';
      ...
      echo '<!-- FILTER OPTION -->';
      echo '<div class="filter-option">';
      echo '<h6 class="title">Show:</h6>';
      echo '<!-- SELECT BLOCK -->';
      echo '<label for="items_page2" class="select-block">';
      echo '<select name="items_page2" id="items_page2">';
      echo '<option value="0">6 Items per Page</option>';
      echo '<option value="1">12 Items per Page</option>';
      echo '</select>';
      echo '<!-- SVG ARROW -->';
      echo '<svg class="svg-arrow face-down">';
      echo '<use xlink:href="#svg-arrow"></use>';
      ...
      <div class="product-list v2">
        ...
        <div class="product-list-item">
          ...
          <a href="#">
            <figure class="product-img">
              <img src="img/products/07.png" alt="product01">
            </figure>
          </a>
          <!-- /PRODUCT IMG -->
        ...
        <div class="product-list-item">
          ...
          <a href="#">
            <figure class="product-img">
              <img src="img/products/08.png" alt="product02">
            </figure>
          </a>
          <!-- /PRODUCT IMG -->
...
echo '<!-- SVG GRID -->';
echo '<svg style="display: none;">';
echo '<symbol id="svg-grid" viewBox="0 0 16 16" preserveAspectRatio="xMinYMin meet">';
echo '<g>';
echo '<g>';
echo '<path fill-rule="evenodd" clip-rule="evenodd" d="M0,6h6V0H0V6z M10,0v6h6V0H10z M0,16h6v-6H0V16z M10,16h6v-6h-6';
echo 'V16z"/>';
echo '</g>';
echo '</g>';
echo '</symbol>';
...
echo '<!-- SVG LIST -->';
echo '<svg style="display: none;">';
echo '<symbol id="svg-list" viewBox="0 0 16 14" preserveAspectRatio="xMinYMin meet">';
echo '<g>';
echo '<g>';
echo '<path fill-rule="evenodd" clip-rule="evenodd" d="M6,0v2h10V0H6z M6,8h10V6H6V8z M6,14h10v-2H6V14z M0,2h4V0H0V2z';
echo 'M0,8h4V6H0V8z M0,14h4v-2H0V14z"/>';
echo '</g>';
echo '</g>';
echo '</symbol>';
echo '</svg>';
