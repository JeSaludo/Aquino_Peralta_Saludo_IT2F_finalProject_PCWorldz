...
echo '<!-- /SVG ARROW -->';
echo '</span>';
echo '<span class="path current">404 Error Page</span>';
echo '</p>';
echo '<!-- SECTION NAVIGATION PATH -->';
echo '</div>';
echo '<!-- /SECTION NAVIGATION -->';
...
echo '<div class="section-decoration big">';
echo '<!-- SVG CROSS -->';
echo '<svg class="svg-cross large">';
echo '<use xlink:href="#svg-cross"></use>';
echo '</svg>';
echo '<!-- /SVG CROSS -->';
echo '';
echo '<i class="s-icon icon-ghost"></i>';
echo '</div>';
echo '<!-- /SECTION DECORATION -->';
echo '<h3 class="title medium">Oooops! Page not Found</h3>';
echo '<h5 class="title small">Seems that we have a problem!</h5>';
echo '<p>The page you are looking for has been moved or doesn’t exist anymore, if you like you can return to our homepage. If the problem persists, please send us an email to <a href="mailto:info@tricksterhelmets.com" class="link medium no-hover">info@pcworldz.com</a></p>';
echo '</div>';
echo '<!-- /SECTION MESSAGE -->';
echo '';
echo '<!-- SECTION ACTIONS -->';
echo '<div class="section-actions">';
echo '<a href="index.php" class="button dark">Return to Home</a>';
echo '<a href="shop-sidebar-grid.php" class="button">Continue Shopping</a>';
echo '</div>';
echo '<!-- /SECTION ACTIONS -->';
echo '</div>';
echo '<!-- /SECTION -->';
